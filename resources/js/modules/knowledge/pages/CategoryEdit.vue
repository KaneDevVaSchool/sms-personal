...
const form = useForm({
    ...
    parent_id: props.category.parent_id ?? ('' as string | number),
});
...
function submit() {
    form
        ...
        .patch(route('knowledge.categories.update', props.category.id));
}
</script>
...
<template>
    ...
    >
        <h1 class="mb-6 text-2xl font-semibold dark:text-gray-100">Edit category</h1>
